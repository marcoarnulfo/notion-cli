...
- **Linux or macOS runners**, amd64 or arm64. Windows runners are supported through Git Bash; anything else fails with an explicit message rather than installing something wrong.
