...
|---|---|---|
| `0` | OK | success |
| `1` | Error | a generic failure — a network/API error, or `doctor` reporting a failed check |
...
| `4` | Duplicate | the ticket key matches more than one row (`upsert`, `get`) |
| `5` | Auth | no token was found, or Notion rejected it (401/403) |
